...
class SearchActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val trackRecycleView = findViewById<RecyclerView>(R.id.track_recycleView)
        trackRecycleView.layoutManager = LinearLayoutManager(this,LinearLayoutManager.VERTICAL, false)
        trackRecycleView.adapter = TrackAdapter(trackList)
